...
{
    public partial class GeneralSettingsAdminView
    {
        ...
        private async Task<bool>
            SaveDispatchCloseoutChecklistDefinitionAsync(
                uint id,
                string displayName,
                bool isActive,
                int sortOrder,
        ...
        private async void
            DeleteSelectedDispatchCloseoutChecklistButton_Click(
                object sender,
                RoutedEventArgs e)
        {
            if (_loading)
